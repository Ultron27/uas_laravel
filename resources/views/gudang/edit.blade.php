...
<div class="container">
	<h1 class="page-title"><a href="{{route('semua_gudang')}}"><i class="fas fa-chevron-left"></i></a>Edit Gudang</h1><br>

	<div class="card">
		<div class="card-header">
			<i class="fas fa-pencil"></i>Edit Gudang
		</div>
		<div class="card-body">
			<form action="{{route('update_gudang')}}" method="post" enctype="mutlipart/form-data">
				...
				<div class="form-group">
					...
					<input type="file" name="foto" value="{{$gudang->pic}}">
				</div>
